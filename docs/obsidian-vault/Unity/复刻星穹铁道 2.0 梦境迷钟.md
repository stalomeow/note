...
![坐标系](../attachments/unity_hsr_dream_ticker_explain.png)
...
![镜子](../attachments/unity_hsr_dream_ticker_explain2.png)
...
![遮挡关系](../attachments/unity_hsr_dream_ticker_explain3.png)
...
![上下三角的定义](../attachments/unity_hsr_dream_ticker_explain4.png)

正六边形则分成下面的六个三角形。

![正六边形的分割](../attachments/unity_hsr_dream_ticker_explain5.png)
...
![拖尾的 artifact](../attachments/unity_hsr_dream_ticker_explain6.png)
